...
const elements = {
  ...
  searchWeather: document.querySelector(".search-btn"),
  temp: document.querySelector(".temp"),
  city: document.querySelector(".city"),
  humidity: document.querySelector(".humidity-percent"),
  windSpeed: document.querySelector(".wind-speed"),
  weatherIcon: document.querySelector(".weatherIcon"),
  changeBG: document.querySelector(".main-bg"),
...
function updateWeatherIcon(weatherType) {
  if (weatherType === "Rain") {
    ...
    elements.changeBG.style.backgroundImage = "url('rain.jpeg')";
  } else if (weatherType === "Clouds") {
    elements.weatherIcon.src = icons.cloud;
    elements.changeBG.style.backgroundImage = "url('clouds.jpeg')";
  } else if (weatherType === "Clear") {
    elements.weatherIcon.src = icons.clear;
    elements.changeBG.style.backgroundImage = "url('clear.jpeg')";
  }
}
